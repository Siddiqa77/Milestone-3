...
function generateResume(data) {
    ...
    if (outputDiv) {
        outputDiv.innerHTML = "\n            <div class=\"resume-section\">\n  \n        <div class=\"layout\">\n          <!-- Left-hand side: Image side -->\n  \n          \n          <div class=\"image-container\">\n          <img src=\"".concat(data.imgupload, "\" alt=\"Profile Picture\" class=\"pic\" id=\"profile-pic\" />\n         \n        </div>\n  \n  \n          <form id=\"career-cert-form\">\n            <!-- Career Objective -->\n            <div class=\"form-group\">\n              <label for=\"career-objective\">About Me</label>\n              <textarea id=\"career-objective\" placeholder=\"Enter your career objective\" readonly required>").concat(data.about, "</textarea>\n            </div>\n  \n            <!-- Certification 1 -->\n            <div class=\"form-group\">\n              <label for=\"cert1-name\">Certification 1 Name</label>\n              <input type=\"text\" id=\"cert1-name\" placeholder=\"Enter the name of your first certification\" value=\"").concat(data.cert1name, "\" readonly required>\n            </div>\n  \n            <div class=\"form-group\">\n              <label for=\"cert1-description\">Certification 1 Description</label>\n              <textarea id=\"cert1-description\" readonly placeholder=\"Enter a description for your first certification\"\n                required>").concat(data.cert1desc, "</textarea>\n            </div>\n  \n            <!-- Certification 2 -->\n            <div class=\"form-group\">\n              <label for=\"cert2-name\">Certification 2 Name</label>\n              <input type=\"text\" id=\"cert2-name\" readonly placeholder=\"Enter the name of your second certification\" value=\"").concat(data.cert2name, "\" required>\n            </div>\n  \n            <div class=\"form-group\">\n              <label for=\"cert2-description\">Certification 2 Description</label>\n              <textarea id=\"cert2-description\" readonly placeholder=\"Enter a description for your second certification\"\n                required>").concat(data.cert2desc, "</textarea>\n            </div>\n             <div class=\"form-group\">\n              <label for=\"language\">Language</label>\n              <textarea class=\"text\" id=\"language\" placeholder=\"languages\"\n                required>").concat(data.language, "</textarea>\n            </div>\n          </form>\n        </div>\n  \n        <!-- Right-hand side: info detail-->\n        <div class=\"right-container\">\n          <h1 class=\"name-heading\" id=\"fullname\">").concat(data.name, "</h1>\n          <span class=\"span\" id=\"profession\">").concat(data.profession, "</span>\n         \n          \n          <form id=\"resume-form\">\n        \n            <div class=\"form-group\">\n              <label for=\"name\">Full Name</label>\n              <input type=\"text\" id=\"name\" placeholder=\"Enter your name\" value=\"").concat(data.name, "\" readonly required>\n            </div>\n           \n  \n            <div class=\"form-group\">\n              <label for=\"email\">Email</label>\n              <input type=\"email\" id=\"email\" placeholder=\"Enter your email\" value=\"").concat(data.email, "\" readonly required>\n            </div>\n  \n            <div class=\"form-group\">\n              <label for=\"phone\">Phone Number</label>\n              <input type=\"text\" id=\"phone\" placeholder=\"Enter your phone number\" value=\"").concat(data.phone, "\" readonly required>\n            </div>\n  \n            <div class=\"form-group\">\n              <label for=\"address\">Address</label>\n              <input type=\"text\" id=\"address\" placeholder=\"Enter your address\" value=\"").concat(data.address, "\" readonly required>\n            </div>\n  \n            <div class=\"form-group\">\n              <label for=\"skills\">Skills</label>\n              <textarea id=\"skills\" placeholder=\"List your skills (comma-separated)\" readonly required>").concat(data.skills, "</textarea>\n            </div>\n  \n            <div class=\"form-group\">\n              <label for=\"experience\">Experience</label>\n              <textarea id=\"experience\" placeholder=\"Describe your experience\" readonly required>").concat(data.experience, "</textarea>\n            </div>\n  \n            <div class=\"form-group\">\n              <label for=\"education\">Education</label>\n              <textarea id=\"education\" placeholder=\"Describe your education\" readonly required>").concat(data.education, "</textarea>\n            </div>\n  \n          </form>\n  \n        </div>\n  \n      </div>\n        ");
    }
}
