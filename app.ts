        ...
        <div class="layout">
          ...
          <form id="career-cert-form">
            ...
            <div class="form-group">
              ...
              <input type="text" id="cert1-name" placeholder="Enter the name of your first certification" value="${data.cert1name}" readonly required>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" id="cert2-name" readonly placeholder="Enter the name of your second certification" value="${data.cert2name}" required>
            </div>
        ...
        <div class="right-container">
          ...
          <form id="resume-form">
            ...
            <div class="form-group">
              ...
              <input type="email" id="email" placeholder="Enter your email" value="${data.email}" readonly required>
            </div>
  
            <div class="form-group">
              <label for="phone">Phone Number</label>
              <input type="text" id="phone" placeholder="Enter your phone number" value="${data.phone}" readonly required>
            </div>
  
            <div class="form-group">
              <label for="address">Address</label>
              <input type="text" id="address" placeholder="Enter your address" value="${data.address}" readonly required>
            </div>
  
            <div class="form-group">
              <label for="skills">Skills</label>
              <textarea id="skills" placeholder="List your skills (comma-separated)" readonly required>${data.skills}</textarea>
            </div>
  
            <div class="form-group">
              <label for="experience">Experience</label>
              <textarea id="experience" placeholder="Describe your experience" readonly required>${data.experience}</textarea>
            </div>
  
            <div class="form-group">
              <label for="education">Education</label>
              <textarea id="education" placeholder="Describe your education" readonly required>${data.education}</textarea>
            </div>
